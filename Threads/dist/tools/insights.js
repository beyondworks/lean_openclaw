 ...
 */
import { GetPostInsightsSchema, GetAccountInsightsSchema, GetPublishingLimitSchema, GetProfileSchema, } from "../schemas/index.js";
  ...
  Metrics including views, likes, replies, reposts, and quotes.`,
        ...
        try {
            ...
            if (params.response_format === "json") {
                return { content: [{ type: "text", text: JSON.stringify({ thread_id: params.thread_id, insights }, null, 2) }] };
            }
    ...
    // ── Account Insights ───────────────────────────────────────
    server.registerTool("threads_get_account_insights", {
...
Returns:
  Current post/reply usage vs. limits (250 posts, 1000 replies per 24h).`,
        ...
        try {
            ...
            if (params.response_format === "json") {
                return { content: [{ type: "text", text: JSON.stringify(limit, null, 2) }] };
            }
