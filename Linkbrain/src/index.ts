...
server.tool(
    'get_clip',
    'Get detailed information about a specific clip (title, URL, summary, keywords, notes, category, etc.).',
    {
...
server.tool(
    'search_clips',
    'Search clips by keyword query. Searches across titles, summaries, keywords, notes, and content. Supports filters. Use includeContent=true to get the full original text (rawMarkdown) of each clip.',
    {
...
server.tool(
    'create_clip',
    'Save a new clip (bookmark) from a URL. The URL is automatically analyzed to extract title, summary, keywords, and category. You can optionally override these.',
    {
...
server.tool(
    'list_collections',
    'List all collections (folders for organizing clips).',
    {},
